...
@author: zcf
20250405: 比LineCocoMetric_overLapCls少：cls_infos
"""
import itertools
...
class LineCocoMetric(CocoMetric):
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            if 'line_pred_instances' in data_sample:
                ...
                result['labels'] = np.concatenate((result['labels'], copy.deepcopy(labels2.cpu().numpy())+self.box_num_cls), axis=0) #TODO!
                #---------------------zhou line_pred_instances
            # parse gt
            gt = dict()
