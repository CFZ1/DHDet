# fuse /mmdetection_v3d3d0/mmdet/models/task_modules/coders/yolo_bbox_coder.py and https://github.com/hhaAndroid/mmdetection-mini
...
class ScaleYOLOBBoxCoder(BaseBBoxCoder):
    """YOLO BBox coder.
    ...
    def __init__(self, eps: float = 1e-6, scale_x_y=1.0, **kwargs): #------change 1
        super().__init__(**kwargs)
        self.eps = eps
        self.scale_x_y = scale_x_y #------change 2
    # no change 
    ...
    def decode(self, bboxes: Union[Tensor, BaseBoxes], pred_bboxes: Tensor,
        ...
        xy_centers = (bboxes[..., :2] + bboxes[..., 2:]) * 0.5 + (pred_bboxes[..., :2] * self.scale_x_y - 0.5 * (self.scale_x_y - 1) - 0.5) * stride #(pred_bboxes[..., :2] - 0.5) * stride, ------change 3
        whs = (bboxes[..., 2:] -
