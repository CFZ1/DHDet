...
LOOPS = Registry('loop', parent=MMENGINE_LOOPS, locations=['mmyolo.engine.runner'])
...
METRICS = Registry(
    'metric', parent=MMENGINE_METRICS, locations=['mmyolo.evaluation']) # change by zhou ,mmyolo.engine
...
VISUALIZERS = Registry(
    'visualizer', parent=MMENGINE_VISUALIZERS, locations=['mmyolo.visualization'])
