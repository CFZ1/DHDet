# Copy from /media/zcf/extra/zcf/code/231108_FoundationModels/mmyolo_forv8/mmdetection/tools/analysis_tools/analyze_logs.py
import argparse
import json
...
def plot_curve(log_dicts, args):
    ...
    for i, log_dict in enumerate(log_dicts):
        ...
        for j, metric in enumerate(metrics):
            ...
            for epoch in epochs:
                if 'loss' in metric:
                    ys += [np.mean(log_dict[epoch][metric])]
                else:
