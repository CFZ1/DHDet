...
convert_dict_p5 = { ###################act--->activate
    ...
    'model.8.cv1': 'backbone.stage4.1.conv1', #SPP
    'model.8.cv2': 'backbone.stage4.1.conv2', #SPP
...
def main():
    ...
    convert('/media/zcf/extra/zcf/code/231108_FoundationModels/mmyolo_forv8/yolov5_v5/yolov5s.pt', 
            '/media/zcf/extra/zcf/code/231108_FoundationModels/mmyolo_forv8/yolov5_v5/yolov5sV5backbone.pth')
